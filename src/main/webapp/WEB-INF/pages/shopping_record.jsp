...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<input type="text" class="form-control" id="evaluationText" placeholder="禁止输入非法字符" >
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">关闭
				</button>
				<button type="button" class="btn btn-primary btn-success" onclick="addToEvaluation()">
					提交
				</button>
			</div>
		</div><!-- /.modal-content -->
        ...
        for(var i=0;i<allShoppingRecords.length;i++){
            ...
            if(allShoppingRecords[i].orderStatus == 0){
                ...
                receiveHTMLTemp += '<tr>'+
                        ...
                        '<td>'+orderArray[allShoppingRecords[i].orderStatus]+'</td>'+
                        '<td>'+
                        '<button class="btn btn-primary btn-sm btn-success" onclick="showModal('+product.id+')">评价</button>'+
                        '</td>'+
                        '</tr>';
                receiveCounts++;
            }
...
function showModal(productID){
    ...
    function addToEvaluation() {
        ...
        evaluation.productId =document.getElementById("productID").value;
