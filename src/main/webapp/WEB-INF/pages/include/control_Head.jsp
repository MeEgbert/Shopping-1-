					...
					<div class="row">
						<div class="col-md-3 col-sm-12">
							<div class="logo-area text-center text-uppercase">
								<a href="#"><img src="${cp}/image/icon/logo.png" alt="" /></a>
							</div>
						</div>
...
<div class="navbar-form navbar-right"  style="padding-top:1%;">
                ...
                <button class="btn btn-success" onclick="searchProduct();">查找商品</button>
            </div>
<ul class="nav navbar-nav navbar-left" text-align="center">
<li><a href="#">主页</a></li>
										<li><a href="#">购物</a>
