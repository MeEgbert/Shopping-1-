...
<div class="container-fluid">
    ...
    <div class="col-sm-offset-2 col-md-offest-2">
        ...
        <div  class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-sm-6 col-md-6">
                    <input type="text" class="form-control" id="inputUserName" placeholder="用户名" readonly>
                </div>
            </div>
            <div class="form-group">
		...
		<input type="radio" name="optionsRadiosinline" id="man" value="option1" style="width: 20px;"> 男
	</label>
	<label class="radio-inline">
		<input type="radio" name="optionsRadiosinline" id="woman"  value="option2" style="width: 20px;"> 女
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6 col-md-6">
                    <input type="text" class="form-control" id="address" placeholder="xx省xx市xx县/区xxx" />
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-6">
                    <button class="btn btn-lg btn-primary btn-block btn-success" type="submit" onclick="startUpdate()">确认修改</button>
                </div>
            </div>
        </div>
        <br/>
