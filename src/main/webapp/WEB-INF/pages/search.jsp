		...
		<div class="row margin-t">
			<div class="form-horizontal">
				...
				<div class="form-group form-group-lg col-sm-6 col-md-6">
					<input type="text" class="form-control" id="newSearchKeyWord" placeholder="SHOPZON" />
				</div>
				<button class="btn btn-primary btn-lg col-sm-2 col-md-2 big-button btn-success" onclick="searchPre()">查找商品</button>
			</div>
		</div>
	</div>
	<div class="container">
